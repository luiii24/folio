    ...
    <section className="blog section" id="blog">
     <div className="container">
      <div className="row">
       ...
       <h2>Jenis Kucing Ras yang Cocok Dipelihara Anak</h2>
       </div> 
      </div>
      <div className="row">
       <div className="blog-item-posts">
         <p>
         ...
         <p>
            Berikut adalah beberapa ras kucing yang dikenal ramah dan cocok untuk menjadi sahabat kecil:
          </p>
         <h1>1. Persia</h1>
         <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/fb/Kemra2.jpg/470px-Kemra2.jpg"></img>
         <p>
         ...
         <h1>3. Ragdoll</h1>
         <img src="https://cdnwpseller.gramedia.net/wp-content/uploads/2022/12/ragdolll-608x456.jpg"></img>
         <p>
         Kucing Ragdoll – Ragdoll merupakan salah satu ras kucing yang mempunyai harga tinggi. Sebagai hewan peliharaan, kucing memiliki jenis yang beragam. Terdapat beberapa jenis kucing ras yang populer serta banyak diminati oleh para pecinta kucing. Mulai dari kucing domestik, kucing anggora, kucing persia, kucing siam, kucing maine coon, hingga kucing sphynx yang memiliki ciri khas, yakni tubuh tanpa bulu.
           </p>
         <p>
         ...
         <h1>4. Birman</h1>
         <img src="https://www.purina.co.id/sites/default/files/styles/ttt_image_510/public/2021-01/Birma.1.webp?itok=njYoqTpj"></img>
         <p>
         ...
         <p>
         Meski asal-usulnya tidak tercatat dengan jelas, tetapi sepasang kucing Birman dibawa ke Prancis sekitar tahun 1919, dan dari kedua kucing itu ras Birman menjadi banyak di negara-negara Barat. Tetapi, kucing Birman nyaris punah sebagai ras dalam Perang Dunia II dan kemudian banyak dikawin-silangkan dengan ras berambut panjang (terutama Persia) dan juga Siamese untuk mengembalikan populasi ras mereka. Di awal 1950-an, anak-anak kucing Birman murni kembali dikembangbiakkan. Hasil perkembangbiakan ini kemudian populer di Inggris tahun 1965.
           </p>
         <p>
         Meskipun ras ini cenderung sangat baik dengan anak-anak, setiap kucing memiliki kepribadian yang berbeda berdasarkan pelatihan dan pengalaman hidup. Silakan berkonsultasi dengan organisasi adopsi, jika Anda mengadopsi, untuk detail tentang karakter kucing tertentu.
           </p>
         <h1>5. American Shorthair</h1>
         <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTD6LeNN9-rP3-tpitT6spyfZHNvPHYBm0HDtPZn_sBeib1T3zyo0Useb-k&s=10"></img>
         <p>
         American shorthair merupakan jenis kucing dengan kondisi fisik cukup sehat. Jika hewan peliharaan ini dirawat dengan tepat, dan jika kamu cukup beruntung, kucing mungkin hanya perlu menemui dokter hewan untuk pemeriksaan rutin serta kondisi kesehatan yang berkaitan dengan bertambahnya usia. Dari segi ukuran, jenis kucing ini tergolong berukuran medium.
           </p>
         <p>
         Namun, American shorthair adalah jenis hewan yang aktif dan senang bergerak atau bermain bersama pemiliknya. Maka dari itu, penting untuk memastikan kucing ini mendapat asupan makanan serta pola diet yang baik untuk menjaga fisiknya. Sebab, masalah seputar berat badan sering menjadi penyakit yang mungkin terjadi pada kucing yang sudah tua. 
           </p>
       </div>
      </div>
     </div>
